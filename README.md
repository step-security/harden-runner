...
Install the [StepSecurity Actions Security GitHub App](https://github.com/marketplace/stepsecurity-actions-security) to get security alerts.
...
Install the [StepSecurity Actions Security GitHub App](https://github.com/marketplace/stepsecurity-actions-security) to use Harden-Runner GitHub Action for `Private` repositories.
...
- [StepSecurity Actions Security GitHub App](https://github.com/marketplace/stepsecurity-actions-security) only needs `actions: read` permissions on your repositories.
