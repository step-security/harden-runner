...
function printInfo(web_url) {
    ...
    console.log("\x1b[34m%s\x1b[0m", `${web_url}/github/${process.env["GITHUB_REPOSITORY"]}/actions/runs/${process.env["GITHUB_RUN_ID"]}`);
}
...
(() => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const filename = external_path_.join(__dirname, "agent");
        external_https_.get(`https://step-security-agent.s3.us-west-2.amazonaws.com/refs/heads/${env}/agent`, (res) => {
