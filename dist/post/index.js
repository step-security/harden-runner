...
(() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    fs__WEBPACK_IMPORTED_MODULE_0__.writeFileSync("/home/agent/post_event.json", JSON.stringify({ event: "post" }));
    var doneFile = "/home/agent/done.json";
    var counter = 0;
    while (true) {
        if (!fs__WEBPACK_IMPORTED_MODULE_0__.existsSync(doneFile)) {
            counter++;
            if (counter > 10) {
    ...
    console.log("log:");
    var content = fs__WEBPACK_IMPORTED_MODULE_0__.readFileSync(log, "utf-8");
    console.log(content);
    var status = "/home/agent/agent.status";
    if (fs__WEBPACK_IMPORTED_MODULE_0__.existsSync(status)) {
        console.log("status:");
