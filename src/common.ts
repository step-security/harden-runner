...
export async function addSummary() {
  if (process.env.STATE_monitorStatusCode === "200") {
    ...
    await core.summary
      .addSeparator()
      .addImage(
        "https://github.com/step-security/harden-runner/raw/main/images/banner.png#gh-light-mode-only",
        "StepSecurity Harden-Runner",
        { width: "200" }
      ).addImage("https://github.com/step-security/harden-runner/raw/main/images/banner-dark.png#gh-dark-mode-only",
      "StepSecurity Harden-Runner",
      { width: "200" })
